...
<head>
  ...
  <link href="vendor/aos/aos.css" rel="stylesheet">
   ...
   <style type="text/css">
   	...
   	.food-add-title input{
  background-color: #1a1814;
  border: #1a1814; 	
  color: white;
  width: 25px;
}
.food-add-title button{
  background-color: #1a1814;
  border: #1a1814;
  color: white; 	
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab-3">Italian</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab-4">Shakes</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab-5">Sandwiches</a>
              </li>
            </ul>
          </div>
